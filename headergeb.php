...
if(isset($_POST['Programma'])){
    $_SESSION['user'] = $user;
    echo "<script type='text/javascript'> document.location = 'Programma.php'; </script>";
}
if(isset($_POST['Kaart'])){
    $_SESSION['user'] = $user;
    echo "<script type='text/javascript'> document.location = 'Kaart.php'; </script>";
}
if(isset($_POST['Kaartjes'])){
    $_SESSION['user'] = $user;
